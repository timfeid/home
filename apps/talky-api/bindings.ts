...
export type Procedures = {
	...
	channel_find_by_slug: { kind: "query", input: string, output: { id: string; name: string; slug: string; type: ChannelType; niche_id: string }, error: unknown },
	...
	lobby_create_temporary: { kind: "query", input: { name: string; channel_id: string }, output: { id: string; name: string; channel_id: string; owner_user_id: string }, error: unknown },
