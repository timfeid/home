...
export type ProceduresLegacy = { queries: { key: "auth_refresh_token"; input: string; result: { access_token: string; refresh_token: string } } | { key: "channel_find_by_slug"; input: string; result: { id: string; name: string; slug: string } } | { key: "channel_list_in"; input: string; result: { page_info: PageInfo; edges: Edge<T>[]; meta: M } } | { key: "channel_list_users"; input: string; result: { page_info: PageInfo; edges: Edge<T>[]; meta: M } } | { key: "niche_find_by_slug"; input: string; result: { name: string; slug: string; id: string } } | { key: "niche_list"; input: { before: string | null; after: string | null; first: number | null; last: number | null; niche_id: string }; result: { page_info: PageInfo; edges: Edge<T>[]; meta: M } }; mutations: { key: "auth_login"; input: { username: string; password: string }; result: { access_token: string; refresh_token: string } }; subscriptions: never }
...
export type Procedures = {
	...
	channel_find_by_slug: { kind: "query", input: string, output: { id: string; name: string; slug: string }, error: unknown },
	channel_list_in: { kind: "query", input: string, output: { page_info: PageInfo; edges: Edge<T>[]; meta: M }, error: unknown },
	channel_list_users: { kind: "query", input: string, output: { page_info: PageInfo; edges: Edge<T>[]; meta: M }, error: unknown },
