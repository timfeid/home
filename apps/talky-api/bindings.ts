...
export type Procedures = {
	...
	channel_find_by_slug: { kind: "query", input: string, output: { id: string; name: string; slug: string; type: ChannelType }, error: unknown },
	...
	channel_list_in: { kind: "query", input: string, output: { id: string; name: string; slug: string; type: ChannelType }[], error: unknown },
