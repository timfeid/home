...
<div class="border-t border-gray-400 bg-gray-200 p-1">
	<form onsubmit={handleSubmit} class="flex items-center">
		<input
			type="text"
			bind:value={message}
			placeholder="Type a message or command..."
			class="flex-1 border border-gray-400 px-2 py-1 font-mono text-sm"
		/>
		<button type="submit" class="border border-l-0 border-gray-400 bg-gray-300 px-2 py-1">
			<Send class="h-4 w-4" />
		</button>
	</form>
</div>
